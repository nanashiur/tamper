// ==UserScript==
// @name         🏰 TDHRCU0001 20260101 M27
// @namespace    tdr-fixed-room-date-rank
// @version      1.20
// @description  /hotel/reserve/ のPOSTで 部屋HOTDHRCU0001N・useDate=20260101・hotelPriceFrameID=M27 を強制。QueueItヘッダも同部屋に同期。パネルクリックでON/OFFトグル（初期OFF）。ホテルコードに応じてパネル色変更。
...
(() => {
  ...
  console.log('[tdr-fixed] loaded (OFF) room=HOTDHRCU0001N, date=20260101, rank=M27');
})();
