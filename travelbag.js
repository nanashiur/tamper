...
const VERSION='1.41', INSTALLED='__tdr_travelbag_installed__', PANEL_ID='__tdr_travelbag_option_panel';
...
function createPanel(){
  ...
  vacancySelectButton=makeButton(
    '選択OFF',
    '#777',
    ()=>{
      vacancySelectMode=
