...
// @version      4.51
// @description  Pre-reloads at 10:52:00 and reloads at 10:59:40.7 with random delay (0–300ms). Shows countdown, start time, and delay info.
...
(function () {
  'use strict';
  const main = { h: 10, m: 59, s: 40, ms: 700, max: 300 };
  ...
  const elInfo  = make('customInfo',  78, 'rgba(0,0,128,0.6)', '10:59:40.730');
