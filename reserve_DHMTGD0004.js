// ==UserScript==
// @name         🏨 DHMTGD0004 20260216 M13
// @namespace    tdr-fixed-room-date-rank
// @version      1.22
// @description  /hotel/reserve/ のPOSTで 部屋HODHMTGD0004N・useDate=20260216・hotelPriceFrameID=M13 を強制。QueueItヘッダも同部屋に同期。パネルクリックでON/OFFトグル（初期OFF）。ホテルコードに応じてパネル色変更。
...
(() => {
  ...
  console.log('[tdr-fixed] loaded (OFF) room=HODHMTGD0004N, date=20260216, rank=M13');
})();
